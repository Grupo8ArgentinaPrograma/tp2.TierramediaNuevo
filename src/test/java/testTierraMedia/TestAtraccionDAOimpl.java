...
public class TestAtraccionDAOimpl {
	...
	public void queBorraAtraccion() {
		...
		assertNull(atra.encontrarPorNombre("AtraccionABorrar"));
	...
	public void queCuentaTodasLasAtracciones() {
		...
		assertEquals(total,25);//Comprobar el número de elementos dentro de la tabla Atracciones en la db
	}
	...
	public void queEncuentraATodasLasAtracciones() {
		Atraccion a5 = atra.encontrarPorNombre("Moria");//Primera atracción
		Atraccion a6 = atra.encontrarPorNombre("Rhun");//Ultima atracción
		Atraccion a7 = atra.encontrarPorNombre("Bree");//Atracción del medio
